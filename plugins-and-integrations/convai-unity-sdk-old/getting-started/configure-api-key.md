...
For production deployments where storing the key in source control is not acceptable, implement a custom `ICredentialProvider` that reads the key from a secure source. See [Custom Credential Provider](/broken/pages/51a32a89e6ce1cfe9c91a8a76600d11be8385582) for details.

## Next Steps

With your API key in place, import a sample scene to verify the SDK is working before you build your own scene.

{% content-ref url="/broken/pages/a6cbf290003b6cf4b25947dc455445017ff2bdd2" %}
[Broken link](/broken/pages/a6cbf290003b6cf4b25947dc455445017ff2bdd2)
{% endcontent-ref %}
