---
description: >-
  Add ConvaiAttentionController, ConvaiEyeGazeActuator, and
  ConvaiHeadLookActuator to a character, assign profiles, and verify eye and
  head tracking in Play Mode.
---

# Quick Start

## Add Eye and Head Tracking to Your Character

This guide walks through the minimum setup to get eye contact and natural head movement working on an AI character. By the end, the character tracks the main camera with its eyes and head, with procedural saccades and blinks.
...
{% content-ref url="/broken/pages/61010d9f9af558f3e1333d094f4057892e848c67" %}
[Broken link](/broken/pages/61010d9f9af558f3e1333d094f4057892e848c67)
{% endcontent-ref %}
