---
description: >-
  Complete API reference for ConvaiRestClient.Memory and
  ConvaiRestClient.EndUsers — all method signatures, parameters, return types,
  identity interfaces, and data models.
---

# Scripting API Reference

## Long-Term Memory Scripting API Reference

This page is the complete reference for all Long-Term Memory scripting APIs in the Convai Unity SDK. It covers the `ConvaiRestClient` entry points, every method on `MemoryService` and `EndUsersService`, the memory-related methods on `CharacterService`, identity interfaces, and all data model types.

{% hint style="warning" %}
**Beta API.** The LTM REST API methods (`Memory`, `EndUsers`, and memory-related `Characters` methods) use the Convai beta API endpoint. Signatures are stable but subject to change. Pin your SDK version in production.
{% endhint %}
...
The main entry point for all LTM operations. Create one instance per operation scope and dispose it when finished.
...
| `DisplayName`    | —                     | `string`                     | **Computed** — `Metadata["name"]` if present, otherwise `"User " + EndUserId[..8]` |
...
See [Troubleshooting & Diagnostics](/broken/pages/22857bedd4848a8b2e4dae34725111402428c018) for the complete HTTP status code reference.

***

## Next Steps

{% content-ref url="/broken/pages/22857bedd4848a8b2e4dae34725111402428c018" %}
[Broken link](/broken/pages/22857bedd4848a8b2e4dae34725111402428c018)
{% endcontent-ref %}
