...
{% hint style="warning" %}
**Screenshot required before publishing:** Capture the NPC `GameObject` selected in the Unity Inspector, showing all four components (`ConvaiCharacter`, `ConvaiActionConfigSource`, `ConvaiActionDispatcher`, `TransformMoveToActionExecutor`) stacked in the component list. Use the SDK version documented on this page.
{% endhint %}
