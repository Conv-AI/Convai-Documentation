---
description: >-
  Complete public API reference for the Convai Actions system — all types,
  properties, methods, events, and enums for ConvaiActionDispatcher,
  ConvaiCharacter, ConvaiActionConfigSource, and related types
---
...
This page documents every public type in the Convai Actions system. All types are in the `Convai.Runtime.Actions`, `Convai.Runtime.Components`, or `Convai.Shared.Actions` namespaces unless noted.
...
See [Debugging & Troubleshooting](/broken/pages/df087fe0ba6d2bfabc74b7b6da3d12e911f48d82) for the full Inspector field reference and usage guide.
...
For practical code patterns using this API, see [Usage Examples](/broken/pages/ea77f6ab34aaa6446c00ca4b9c598e2cd15e0066). For diagnosing pipeline issues, see [Debugging & Troubleshooting](/broken/pages/df087fe0ba6d2bfabc74b7b6da3d12e911f48d82).
