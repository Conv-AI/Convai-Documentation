---
description: >-
  Diagnose action pipeline issues using ConvaiActionDebugProbe's Inspector
  counters and test batch injection — with a complete symptom/cause/fix
  reference for common failures.*
---

# Debugging & Troubleshooting

## Actions Debugging and Troubleshooting
...
* **Counter increments** → the backend returned an action batch; proceed to Step 2.
...
| ------------------------------------------------------------ | ------------------------------------------------------------------- |
| `No local action definition found for 'X'`                   | Action name mismatch — see Step 4                                   |
...
* **Executor field empty** → the step will fail with "missing a valid executor." Drag the executor component from the Inspector into the Executor field.
...
If the diagnostic checklist and troubleshooting table don't resolve your issue, check the [Scripting Reference](/broken/pages/2ef79348f99f367e8425911bab3e6313a100c8bc) to verify your API usage matches the correct signatures. For the complete action pipeline setup from scratch, start with [Quick Start](/broken/pages/1e9ec58174298200bf97914cd19d156337a38de2).
