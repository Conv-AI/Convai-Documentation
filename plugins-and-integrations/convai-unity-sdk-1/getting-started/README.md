...
<table data-view="cards"><thead><tr><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Configure API key</strong><br>Connect your project to Convai with your account API key.</td><td><a href="configure-api-key.md">configure-api-key.md</a></td></tr><tr><td><strong>Import and run sample scenes</strong><br>Verify the SDK works before building your own scene.</td><td><a href="import-and-run-sample-scenes.md">import-and-run-sample-scenes.md</a></td></tr><tr><td><strong>Understand scene components</strong><br>Learn what each component does and how they depend on each other.</td><td><a href="understand-scene-components.md">understand-scene-components.md</a></td></tr><tr><td><strong>Build a custom scene</strong><br>Build a Convai scene from scratch using the Setup Required Components command.</td><td><a href="build-a-custom-scene.md">build-a-custom-scene.md</a></td></tr><tr><td><strong>Configure conversation input mode</strong><br>Choose between hands-free and push-to-talk input.</td><td><a href="configure-conversation-input-mode.md">configure-conversation-input-mode.md</a></td></tr><tr><td><strong>Configure audio</strong><br>Tune microphone input and character audio output.</td><td><a href="configure-audio.md">configure-audio.md</a></td></tr><tr><td><strong>Add chat UI</strong><br>Display conversation transcripts in your scene.</td><td><a href="add-chat-ui.md">add-chat-ui.md</a></td></tr><tr><td><strong>Add lip sync</strong><br>Drive character blendshapes in sync with voice audio.</td><td><a href="add-lip-sync/README.md">add-lip-sync/README.md</a></td></tr><tr><td><strong>Validate your setup</strong><br>Confirm everything is connected and working before deployment.</td><td><a href="validate-your-setup.md">validate-your-setup.md</a></td></tr></tbody></table>
