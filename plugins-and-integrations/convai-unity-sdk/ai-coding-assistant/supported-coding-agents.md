...
{% hint style="info" %}
Installing, updating, or removing the managed block is a manual action — it does not run automatically. Trigger it from the **AI Coding** section of the Convai Editor window, opened from **Convai > Convai Editor**.
{% endhint %}
