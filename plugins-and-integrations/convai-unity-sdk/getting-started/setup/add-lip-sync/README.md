...
## Animate Character Faces from Voice Audio
...
{% hint style="warning" %}
If the mouth does not move, confirm that your `SkinnedMeshRenderer` blendshape names match the expected naming convention for the chosen profile. ARKit uses camelCase names (e.g., `jawOpen`, `mouthSmileLeft`). MetaHuman uses the `CTRL_expressions_` prefix. Use a custom map if your rig uses different names — see [Profiles and Mappings](/broken/pages/1713961031bb9d43272fe6dd25b231e6fa08e408).
{% endhint %}
{% endstep %}
{% endstepper %}
...
| ------------ | ----------------- | ----------- | -------------------------------------------------------- |
| ARKit        | `arkit`           | 61          | Apple-rigged characters, ReadyPlayerMe, some custom rigs |
...
{% hint style="info" %}
If your character was rigged by an artist using custom blendshape names, create a custom map to route the SDK's output channels to your rig's actual names. See [Creating a Custom Map](/broken/pages/09ad275b054cfbbd83d104205b96415b9dbdb763).
{% endhint %}
...
For cases where the bundled profiles and auto-maps do not cover your rig, create custom assets.

{% content-ref url="/broken/pages/1713961031bb9d43272fe6dd25b231e6fa08e408" %}
[Broken link](/broken/pages/1713961031bb9d43272fe6dd25b231e6fa08e408)
{% endcontent-ref %}
...
After lip sync is working, validate your complete setup to confirm everything is connected correctly.

{% content-ref url="/broken/pages/ded28696e215991f77b0be01183f49c7c847d74d" %}
[Broken link](/broken/pages/ded28696e215991f77b0be01183f49c7c847d74d)
{% endcontent-ref %}
