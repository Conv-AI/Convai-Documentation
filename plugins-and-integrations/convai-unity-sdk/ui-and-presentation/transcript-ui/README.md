...
Users can also switch modes through the built-in Settings Panel. See [Settings Panel](../settings-panel/) for details on what modes the panel exposes at runtime.
