...
This section guides you from installing the Convai Unreal Engine plugin through placing your first talking character in a level. Follow the pages in the order shown below for the fastest path to a working result.
...
<tbody>
<tr>
<td><strong>Prerequisites</strong><br>Review what you need before installing the plugin.</td>
...
<tr>
<td><strong>Run the bundled demo</strong><br>Open the demo level that ships with the plugin and verify that the character responds.</td>
...
<tr>
<td><strong>Configure conversation input</strong><br>Switch between push-to-talk and hands-free mode and send text messages.</td>
