...
- The Convai plugin is installed and enabled (see [Install the Convai plugin](install-the-convai-plugin.md)).
- Your API key is configured (see [Configure your API key](configure-your-api-key.md)).
...
{% content-ref url="scene-components-reference.md" %}
[Scene components reference](scene-components-reference.md)
{% endcontent-ref %}
