...
If you have not already done this, open your player pawn Blueprint and add `UConvaiPlayerComponent`. For detailed steps, see [Add your first Convai character](add-your-first-convai-character.md).
...
**Fix:** Verify the **Character ID** on the **Convai Chatbot** component and confirm your API key is set (see [Configure your API key](configure-your-api-key.md)). Confirm the player pawn has `UConvaiPlayerComponent` added.
