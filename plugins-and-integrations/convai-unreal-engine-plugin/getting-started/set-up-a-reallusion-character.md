...
Enter Play mode and speak to the character using push-to-talk (default: **V**) or the chat widget.

{% hint style="success" %}
Voice and text input are reaching the character. Body and idle animations play at this point. Facial animation is added in the next section.
{% endhint %}
