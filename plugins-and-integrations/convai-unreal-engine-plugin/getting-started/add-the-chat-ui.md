...
The screen-space overlay is included in `BP_ConvaiPlayerComponent`. When you added `BP Convai Player Component` to your player pawn (see [Add your first Convai character](add-your-first-convai-character.md)), the widget was already included. It appears automatically in Play mode — no additional setup is required.
...
Adding the 3D widget and hands-free conversation in a VR project
{% endembed %}
