...
This page is a reference for the four components the Convai plugin provides. Use it while building or debugging your scene. For a step-by-step walkthrough of adding components, see [Add your first Convai character](add-your-first-convai-character.md).
