...
{% hint style="info" %}
If the character is not yet set up, complete [Add your first character](../../getting-started/add-your-first-convai-character.md) first, then return here.
{% endhint %}
...
See [Troubleshoot emotion](troubleshoot-emotion.md) for detailed guidance.
