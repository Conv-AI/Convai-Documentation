...
description: >-
  Enable gaze attention on the Convai Player Component and verify that a
...
[gaze-attention-reference.md](gaze-attention-reference.md)
{% endcontent-ref %}

{% content-ref url="gaze-attention-usage-examples.md" %}
[gaze-attention-usage-examples.md](gaze-attention-usage-examples.md)
{% endcontent-ref %}
