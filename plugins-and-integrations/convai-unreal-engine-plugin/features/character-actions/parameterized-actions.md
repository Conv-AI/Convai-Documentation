...
description: >-
  Declare typed action parameters and read resolved values in Blueprint handlers
  for text, references, choices, and animations.
---
...
Custom and Parameterized Actions Walkthrough
{% endembed %}
...
[actions-blueprint-reference.md](actions-blueprint-reference.md)
{% endcontent-ref %}
...
[character-actions-examples.md](character-actions-examples.md)
{% endcontent-ref %}
