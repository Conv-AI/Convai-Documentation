...
If the character does not reference either value, see [Troubleshoot dynamic context](troubleshoot-dynamic-context.md).
{% endstep %}
{% endstepper %}
...
Read [How dynamic context works](how-dynamic-context-works.md) for the mental model, then [Dynamic context usage examples](dynamic-context-usage-examples.md) for more Blueprint patterns.
