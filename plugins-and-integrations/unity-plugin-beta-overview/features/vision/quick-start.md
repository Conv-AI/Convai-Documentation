...
<figure><img src="../../../../.gitbook/assets/Screenshot 2026-05-13 225029.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/Screenshot 2026-05-13 230410.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/Screenshot 2026-05-13 230509.png" alt=""><figcaption></figcaption></figure>
...
{% hint style="warning" %}
If the overlay stays blank or the FPS counter reads zero, verify that `ConvaiRoomManager.Connection Type` is set to **Video** and that the room has fully connected. See [Troubleshooting](troubleshooting-and-diagnostics.md) for a step-by-step diagnosis.
{% endhint %}
...
* [Frame Sources](frame-sources.md) — Switch to a webcam source on desktop, configure mobile camera permissions, or set up Meta Quest passthrough.
* [Publishing & Policies](publishing-and-policies.md) — Tune frame rate and bitrate, or switch to Manual policy for explicit control over when publishing starts.
* [Debug Preview](debug-preview.md) — Customise the overlay position, size, and statistics display.
* [Troubleshooting & Diagnostics](troubleshooting-and-diagnostics.md) — If anything is not working, start here.
