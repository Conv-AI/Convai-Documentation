...
* **Voice Activity Detection (VAD)** — Automatically detects when a player speaks, creating a smoother, more natural conversational flow.
* **Environment Vision** — Enable your AI to perceive and describe its surroundings for richer environmental awareness.
* **Convai Editor UI** — A new, unified in-editor interface that simplifies how you work with Convai. Access samples, manage features and configurations, handle account setup, monitor updates and announcements, and connect your API key — all from one centralized panel within Unreal.
* **Native Unreal Integration** — Fully compatible with Unreal’s Blueprint system, making it easy to implement Convai features in both prototype and production environments.

Together, these innovations create a streamlined workflow for developers while enhancing player immersion with fast, responsive, and intelligent AI interactions.
...
Join the community and share your insights on the [Convai Developer Forum](https://forum.convai.com/).
