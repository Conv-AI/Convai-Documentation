...
description: Understand what a chat experience is, what a moderated text room does and does not do, and where to start in this section.
...
<table data-view="cards"><thead><tr><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Open My Experiences</strong><br>Reach the hub where chat experiences and 3D experiences are both created and reopened.</td><td><a href="open-my-experiences.md">open-my-experiences.md</a></td></tr><tr><td><strong>What you need to use Chat Experiences</strong><br>The account and character requirements, and what to do if the controls are missing.</td><td><a href="prerequisites.md">prerequisites.md</a></td></tr><tr><td><strong>Create a chat experience</strong><br>Name the room, pick its type, write its purpose, and read the briefing before it is fixed.</td><td><a href="create-a-chat-experience.md">create-a-chat-experience.md</a></td></tr><tr><td><strong>Add characters to the room</strong><br>Seat characters from your workspaces or by character ID, and watch each one join and be briefed.</td><td><a href="add-characters-to-the-room.md">add-characters-to-the-room.md</a></td></tr><tr><td><strong>Send your first message</strong><br>Write to the room, address a character so that it answers, and read what the thread reports.</td><td><a href="send-your-first-message.md">send-your-first-message.md</a></td></tr><tr><td><strong>Manage your chat experiences</strong><br>Find, rename, duplicate, and delete the chat experiences on your account.</td><td><a href="manage-your-chat-experiences.md">manage-your-chat-experiences.md</a></td></tr><tr><td><strong>Share files with the room</strong><br>What reaches the characters when you attach a file to a message, and what the room keeps afterwards.</td><td><a href="share-files-with-the-room/README.md">share-files-with-the-room/README.md</a></td></tr></tbody></table>
