---
title: What you need to use Chat Experiences
description: What a Convai account needs before you can build a chat experience, which characters you can add to a room, and what to do if the controls are missing.
...
{% content-ref url="open-my-experiences.md" %}
[Open My Experiences](open-my-experiences.md)
{% endcontent-ref %}
