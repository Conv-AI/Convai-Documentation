...
description: >-
  Estimate how many credits your character uses per turn and per month with the
  Convai credit calculator, so you can choose a plan that fits.
---

# Estimate credit usage for a project
...
These figures cover turns only. Add the session duration charges the calculator leaves out:
...
[credit-balance-and-billing-cycle.md](credit-balance-and-billing-cycle.md)
{% endcontent-ref %}
