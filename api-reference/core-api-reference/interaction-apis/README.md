...
description: Enable real-time interaction with AI characters using Convai's Interaction APIs for natural text and voice-based communication.
---
...
The Interaction APIs bridge your characters and users, enabling responsive communication across both textual and voice channels.

{% content-ref url="interaction-api-beta.md" %}
[interaction-api-beta.md](interaction-api-beta.md)
{% endcontent-ref %}
