---
title: Character Crafting APIs
description: Create and configure AI characters with Convai's Character Crafting APIs to define their personality, behavior, knowledge and more.
---
...
{% content-ref url="chat-history-delete-api.md" %}
[chat-history-delete-api.md](chat-history-delete-api.md)
{% endcontent-ref %}
...
{% content-ref url="custom-llm-api.md" %}
[custom-llm-api.md](custom-llm-api.md)
{% endcontent-ref %}

{% content-ref url="text-to-speech-api.md" %}
[text-to-speech-api.md](text-to-speech-api.md)
{% endcontent-ref %}

{% content-ref url="streaming-transcription-api.md" %}
[streaming-transcription-api.md](streaming-transcription-api.md)
{% endcontent-ref %}
