...
These limits apply whether you configure External API in the [Playground](./) or through the [API](../../../api-reference/core-api-reference/character-crafting-apis/external-api.md).
...
* [External API (Playground)](./) — UI setup and examples
